...
function Navbar() {
	return (
		<div className="flex items-center justify-center w-full h-[60px] bg-[#000000b7] shadow-sm fixed z-10 border-b-[5px] border-b-gray-800" >
			<div className='justify-center items-center hidden sm:flex'>
				...
				<button data-text="Awesome" className="buttonv ">
					<span className="actual-text">&nbsp;News&nbsp;</span>
					<span className="hover-text" aria-hidden="true">&nbsp;News&nbsp;</span>
				</button>
			</div>
			<div className="flex items-center justify-around w-full sm:w-[35%] xl:w-[35%]">
				<Link to='/currency' className='font-bold  p-[10px_30px]  cursor-pointer flex items-center uppercase'>
				...
				<Link to='/about' className=' font-bold p-[10px_30px] cursor-pointer flex items-center'>
					<button className='btnlm'>
						<div className="text">
							<span>About</span>
						</div>
						<div className="clone">
